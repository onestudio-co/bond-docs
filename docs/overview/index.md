...
- **New to Bond?** Start with [What Is Bond](what-is-bond.md) to understand the framework
- **Ready to build?** Jump to [Getting Started](../getting-started/index.md) to create your first project
- **Want to understand the architecture?** Read about [Philosophy](philosophy.md) and design decisions
...
Ready to dive in? Continue with [What Is Bond](what-is-bond.md) or jump straight to [Getting Started](../getting-started/index.md).